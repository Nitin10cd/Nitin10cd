<h1 border="none">Hi Devs I'm Nitin Saxena ( SDE 1 )
...
- Architecting full-stack solutions using **MERN, Next.js, Django & React Native**
- Solving complex problems: **550+ DSA challenges** across LeetCode & GFG

**🏆 Achievements:**
- 🥇 **AuraFlix Hackathon** — Top 4 out of 400+ teams
- 🥉 **InnovateX Hackathon** — 3rd Place Winner
- 🌟 **GSSoC 2024** — Active Open Source Contributor

**💡 Currently Focused On:**
Real-time systems, AI integrations, and contributing to open-source projects that make a difference.
